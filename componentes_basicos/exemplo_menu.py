...
class Tela:
    def __init__(self, master):
        ...
        self.mnu_item_arq = tk.Menu(self.mnu_barra)
        ...
        self.mnu_item_fer.add_command(label="Procurar Texto ...", command=None)
        self.mnu_item_fer.add_command(label="Substituir", command=None)
